...
```{r}
#meanVarPlot(AMLExpressionSet, xlim = c(1, 3), ylim = c(0, 3),
...
BEND4 is chosen in all 100 cross-validations.
...
plotFeatureClasses(measurementsVS, classes, targets = "BEND4",
...
- Evaluation of the feature selection stability.
