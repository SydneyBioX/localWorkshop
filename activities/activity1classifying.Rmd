...
```{r, echo = FALSE}
library(knitr)
knitr::opts_chunk$set(echo = TRUE, cache = TRUE, results='hide', fig.show="hide", message = FALSE, warning = FALSE)
...
LRclassesGene <- ifelse(LRprobabilitiesGene > 0.5, levels(classes)[2], levels(classes)[1])
