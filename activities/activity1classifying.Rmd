...
To complete todays workshops you will need to have R and Rstudio installed on your computer.  
...
## Download and Format Tables From GEO

Observe that the process is not streamlined, but do not run the code.
